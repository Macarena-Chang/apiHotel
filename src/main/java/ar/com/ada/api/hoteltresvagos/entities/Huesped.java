...
public class Huesped {
    ...
    //notacion JsonIgnore para que no me traiga las reservas en la consulta huesped (quedaba loopeando)
    @JsonIgnore
    @OneToMany(mappedBy ="huesped", cascade = CascadeType.ALL, fetch = FetchType.EAGER)
    private List<Reserva> reservas = new ArrayList <>(); //el huesped puede tener mas de una reserva! por eso hacemos una lista.
